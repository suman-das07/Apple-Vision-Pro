...
locoScroll.on("scroll", ScrollTrigger.update);
// Tell ScrollTrigger to use Locomotive Scroll as the scroller
ScrollTrigger.scrollerProxy(".main", {
  scrollTop(value) {
